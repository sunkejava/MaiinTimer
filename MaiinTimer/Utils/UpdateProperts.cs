...
namespace BridImage.Utils
{
    public class UpdateProperts
    {
        ...
        private  string GetAppConfig(string strKey)
        {
            ...
            Configuration config = ConfigurationManager.OpenExeConfiguration(cfile);
        ...
        {
            string file = System.Windows.Forms.Application.ExecutablePath.Replace(System.IO.Path.GetFileName(System.Windows.Forms.Application.ExecutablePath), "AppUpdate.exe");
